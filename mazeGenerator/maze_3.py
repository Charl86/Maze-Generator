...
import random
from maze.config import Vars, Colors, Debugger, PygameVars as Pyv
from maze.DoublyLinkedList import Node
from maze.cell import Cell
from maze.border import Border
from interface import Tkinter_Setup as Ts
